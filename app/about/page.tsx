            ...
            <div className='flex items-center justify-center gap-4'>
              {SOCIAL_LINKS.map((link) => (
                <Link
                  ...
                  className='w-10 h-10 flex items-center justify-center rounded-full text-muted-foreground hover:text-foreground hover:border-foreground transition-colors hover:bg-slate-100'
