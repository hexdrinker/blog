...
3e:I[86902,["/_next/static/chunks/561d09b2dcace1dd.js","/_next/static/chunks/34f3c6f00b149678.js","/_next/static/chunks/8ba36b395f30a90d.js","/_next/static/chunks/cc80ad68b16f74f3.js"],"TableOfContents"]
40:I[2718,["/_next/static/chunks/483a12865e0bba97.js","/_next/static/chunks/1d3be43a6dda29b7.js"],"OutletBoundary"]
41:"$Sreact.suspense"
...
> 그리고 10주 간 열정적으로 멘토링을 해주신 5인의 코치님들, 불편함과 운영 피드백을 바로바로 해결해주셨던 매니저님들 모두 고생하셨습니다.
9:["$","aside",null,{"className":"hidden xl:block w-64 shrink-0 self-start sticky top-24","children":["$","$L3e",null,{"content":"$3f"}]}]
...
c:["$","$L40",null,{"children":["$","$41",null,{"name":"Next.MetadataOutlet","children":"$@42"}]}]
e:["$","figure",null,{"className":"imageWrapper","children":["$","img",null,{"src":"https://images.hexdrinker.dev/hanghae/extension.png","alt":"extension","width":"100%"}]}]
f:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"크롬 익스텐션을 언젠가는 한 번은 만들어보고 싶었는데 이런 기회를 이용하지 않으면 앞으로도 미루다가 딱히 할 것 같지 않았다. 그래서 그냥 생각나는 김에 바로 만들었다. 역시 생각날 때 해야한다, 아니면 잘 안하게 된다."}]
10:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"앞으로 좀 더 개선할테니 많은 관심 부탁드립니다 ^^❤️"}]
11:["$","h3",null,{"className":"text-xl font-medium mt-6 mb-3","id":"-그-밖의-경험","children":"🎸 그 밖의 경험"}]
12:["$","figure",null,{"className":"imageWrapper","children":["$","img",null,{"src":"https://images.hexdrinker.dev/hanghae/my-team.png","alt":"my-team","width":"60%"}]}]
13:["$","figure",null,{"className":"imageWrapper","children":[["$","img",null,{"src":"https://images.hexdrinker.dev/hanghae/zep-ggu.png","alt":"zep-ggu","width":"80%"}],["$","figcaption",null,{"children":"ZEP 공간 꾸미기 대회 1등!"}]]}]
14:["$","h2",null,{"className":"text-2xl font-semibold mt-8 mb-4 pb-2 border-b border-border","id":"-사람과-네트워킹","children":"👯 사람과 네트워킹"}]
15:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["내게 있어 항해의 진짜 재미는 ",["$","strong",null,{"children":"\"사람\""}]," 이었다."]}]
16:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"각기 다른 배경을 가진 사람들이지만 모두가 성장에 목 말라있었고 그 간절함이 서로를 자연스럽게 엮어주었다 생각한다."}]
17:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["누군가는 회사에서 퇴사 후 도전했고,",["$","br",null,{}],"\n","누군가는 학교와 회사를 병행하며 끝까지 물고 늘어졌고,",["$","br",null,{}],"\n","누군가는 항상 조용히 묵묵히 과제를 수행하곤 했다.\n나 또한 직장을 다니면서 항해에 임했지만 나보다 더 바쁘고 힘든 사람들은 많았고 그 사람들을 보며 끝까지 해내겠다고 의지를 다잡았다."]}]
18:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["사람들과 보낸 시간은 단순한 협업 이상의 가치가 있었다.",["$","br",null,{}],"\n","같은 과제를 하더라도 다른 해석으로 질문을 주고 받으며 이해를 채워나갈 때도 있었고,",["$","br",null,{}],"\n","졸리고 의지가 꺾이더라도 끝까지 붙잡아주는 사람들과 함께 새벽까지 버텨냈고,",["$","br",null,{}],"\n","멘토링 노트와 이력서 피드백을 서스럼 없이 공유하며 서로를 도와줄 때도 있었다."]}]
19:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"테오 코치의 멘토링 중 그가 했던 말이 기억이 난다."}]
1a:["$","blockquote",null,{"className":"my-4 border-l-2 border-border pl-4 text-muted-foreground","children":["\n",["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"서로 알려주고 나누는 공유 문화가 커뮤니티를 성장시키잖아요? 개발자는 그런 게 참 좋은 거 같아요."}],"\n"]}]
1b:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"개발자란 직업을 갖고 살아온지 적지 않은 시간이 지났지만 이번 시간들을 통해 공유 문화의 가치에 대해 가장 크게 체감한 거 같다."}]
1c:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"물론 공부만 했는가? 그건 아니다. 사람들과 떠들기도 많이 떠들었고 과제를 제출한 금요일 밤엔 구스구스덕이나 갈틱폰 같은 게임을 하기도 했다.\n그 과정에서 가까워진 사람들과 등산도 가고 러닝도 가고(난 안감 ㅎ^^) 모각코도 하고 많은 추억을 남겼다."}]
1d:["$","figure",null,{"className":"imageWrapper","children":[["$","img",null,{"src":"https://images.hexdrinker.dev/hanghae/yongma-mountain.jpeg","alt":"yongma-mountain","width":"50%"}],["$","figcaption",null,{"children":"아차산만 가기로 했는데 용마산까지 가버린"}]]}]
1e:["$","h2",null,{"className":"text-2xl font-semibold mt-8 mb-4 pb-2 border-b border-border","id":"앞으로의-계획","children":"앞으로의 계획"}]
1f:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"항해를 시작할 때 목표로 했던 것 중 하나가 항해가 끝나고 나서도 퇴근하자말자 눕지 않고 부지런하게 삶을 이어가는 것이었다."}]
20:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"그리고 내가 일을 몇 년 하다보니 느낀건데 나는 여유롭게 쉬고 늘어지는 것보다 눈코뜰 새 없이 바쁘게 돌아가는 게 집중력이 더 좋더라. 뭐든 흐지부지 마무리하는 것 없이 모두 다 잘 끝내고픈 욕심이 있고 바쁘게 살며\n일 외의 삶도 좀 더 빡빡하게 채우며 열심히 살아보고 싶어졌다."}]
21:["$","h3",null,{"className":"text-xl font-medium mt-6 mb-3","id":"-스터디-혼자보다-멀리-가기","children":"🧠 스터디: 혼자보다 멀리 가기"}]
22:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["단기 집중형 스터디를 기획해서 운영할 예정이다.",["$","br",null,{}],"\n","단순히 공부만 하는 스터디가 아니라, ‘함께 성장하는 루틴’을 만드는 데 집중하고 싶다."]}]
23:["$","ul",null,{"className":"my-4 ml-6 list-disc space-y-2","children":["\n",["$","li",null,{"className":"leading-7","children":"4~6주 단위 페이즈 기반 집중 스터디 운영"}],"\n",["$","li",null,{"className":"leading-7","children":"트랙별(이직/CS/실무/사이드프로젝트) 구조화"}],"\n",["$","li",null,{"className":"leading-7","children":"미션 → 코드리뷰 → 회고 루틴으로 학습 내재화"}],"\n"]}]
24:["$","figure",null,{"className":"imageWrapper","children":[["$","img",null,{"src":"https://images.hexdrinker.dev/hanghae/study.png","alt":"study","width":"50%"}],["$","figcaption",null,{"children":["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"너무 많은 관심은 부담스럽다. 하지만,, 지금 아니면 언제 이런 관심을\n받아볼려나"}]}]]}]
25:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["아 그리고 술 한 잔 가볍게 하면서 나누는 즐거운 개발 이야기 ",["$","a",null,{"href":"https://github.com/dev-tok-talk","target":"_blank","rel":"noopener noreferrer","className":"text-foreground underline underline-offset-4 hover:text-foreground/80","children":"데브톡톡"}],"도 천천히 진행할 생각이다. 이것 또한 많관부 💘.."]}]
26:["$","h3",null,{"className":"text-xl font-medium mt-6 mb-3","id":"-사이드-프로젝트-불티","children":"🥗 사이드 프로젝트: 불티"}]
...
28:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"그래도 일주일은 쉬고 싶었는데 우리 대장님이 안된대,,, 해야지,,, 해야지 할 수 있다."}]
29:["$","figure",null,{"className":"imageWrapper","children":[["$","img",null,{"src":"https://images.hexdrinker.dev/hanghae/boolti....jpeg","alt":"boolti...","width":"50%"}],["$","figcaption",null,{"children":"힝구리퐁퐁"}]]}]
2a:["$","h3",null,{"className":"text-xl font-medium mt-6 mb-3","id":"-학습메이트-활동","children":"👥 학습메이트 활동"}]
2b:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["학습 메이트 신청을 했다. 이유는 별 거 없고 ",["$","del",null,{"children":"6기 사람들도 나처럼 고통 받는 모습을 보고싶기 때문이다."}]," 멘토링이랑 발제도 더 듣고 싶고 네트워킹을 하면서 좀 더 재밌게 살고 싶어서..."]}]
2c:["$","figure",null,{"className":"imageWrapper","children":[["$","img",null,{"src":"https://images.hexdrinker.dev/hanghae/mate.png","alt":"mate","width":"80%"}],["$","figcaption",null,{"children":"\"시켜줘,,, 항해 학습 메이트\""}]]}]
2d:["$","h3",null,{"className":"text-xl font-medium mt-6 mb-3","id":"-dnd-운영진-활동","children":"🧑🏻‍🎨 DND 운영진 활동"}]
2e:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["예전에 대학교 동기들과 함께 만들었던 ",["$","a",null,{"href":"https://dnd.ac/","target":"_blank","rel":"noopener noreferrer","className":"text-foreground underline underline-offset-4 hover:text-foreground/80","children":"DND"}]," 운영진 활동을 재개하려 한다."]}]
2f:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"한 6년 전 쯤에 1~2기 운영진으로 활동하다가 당시 새 회사에 취업하면서 바빠져서 활동을 중지했었는데 이것도 항해를 계기로 다시 잘 이어갈 생각이다."}]
30:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"항해에서 코치님들의 멘토링을 받으며 얻어가는 것들이 많았다. 원래도 멘토링에 관심이 많아서 학교 다닐 때 후배들을 가르치기도 했고 동아리에서 멘토 활동을 하기도 했는데 그 때마다 난 부족하다는 생각을 많이 들었고 그래서 누군가에게 지식이나 경험을 전달하는 것에 부담감을 느꼈다."}]
31:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"그러나 항해에서의 경험을 통해서 난 그 동안 수직적 전달을 하려고 했지 수평적인 공유를 하려고 했는가? 나도 누군가의 성장을 돕고 나 또한 배울 수 있지 않을까? 란 생각이 들었다."}]
32:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"아직은 보잘 것 없는 경험과 생각일지 모르지만 그 속에서 나의 고민과 선택, 시행착오들을 누군가에게 조금이라도 꺼내보여줄 수 있다면 그 자체로 의미있는 일이 아닐까 싶다."}]
33:["$","blockquote",null,{"className":"my-4 border-l-2 border-border pl-4 text-muted-foreground","children":["\n",["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["나 이 모든 걸 다 거두어갈 수 있을까?",["$","br",null,{}],"\n","예전의 나 같았으면 잘 모르겠다고 했을 거 같다.",["$","br",null,{}],"\n","근데 지금은 아니다, 그냥 한다."]}],"\n"]}]
34:["$","figure",null,{"className":"imageWrapper","children":[["$","img",null,{"src":"https://images.hexdrinker.dev/hanghae/yeonaqueen.png","alt":"yeonaqueen","width":"80%"}],["$","figcaption",null,{"children":"걍 하는거지 뭐"}]]}]
35:["$","h2",null,{"className":"text-2xl font-semibold mt-8 mb-4 pb-2 border-b border-border","id":"-항해","children":"🚢 항해"}]
36:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"왜 항해일까? 언젠가인지는 모르겠지만 과제를 하다 그런 의문이 불현듯 머리를 스쳐지나간 적이 있었다. 수 많은 네이밍을 두고 왜 이 부트캠프 과정의 이름을 항해라 지었을까?"}]
37:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"육상에서의 생활에 비해 힘들고 고된 생활, 바다와 하늘이 만나는 수평선과 그 너머에 있는 무한한 잠재력을 표방하기 위함이 아닐까 싶은데,, 뭐 오피셜한 의미는 잘 모르겠지만 나는 그렇게 생각하고 항해를 진행했다."}]
38:["$","div",null,{"className":"flex justify-center","children":["$","iframe",null,{"width":"80%","height":"400","src":"https://www.youtube.com/embed/BNh_W4wwRzI","frameBorder":"0","allowFullScreen":true}]}]
39:["$","br",null,{}]
3a:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"내가 좋아하는 유다빈 밴드의 항해라는 노래엔 이런 가사가 있다."}]
3b:["$","blockquote",null,{"className":"my-4 border-l-2 border-border pl-4 text-muted-foreground","children":["\n",["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["$","code",null,{"className":"px-1.5 py-0.5 bg-muted rounded text-sm font-mono","children":"\"이제야 마주한 꿈의 대양 춤을 추듯이 흘러가보자\""}]}],"\n"]}]
3c:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["아직 갈 길이 멀지만 항해를 마친 모두에게 작은 박수를 보내고 싶다.",["$","br",null,{}],"\n","그리고 모두의 여정 끝에 더 큰 바다가 기다리고 있길, 그 바다를 즐겁게 춤을 추듯이 나아가길 바란다.\n언젠가 또 같은 바다에서 만날 수 있길 바라며 글을 마친다."]}]
3d:["$","blockquote",null,{"className":"my-4 border-l-2 border-border pl-4 text-muted-foreground","children":["\n",["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"그리고 10주 간 열정적으로 멘토링을 해주신 5인의 코치님들, 불편함과 운영 피드백을 바로바로 해결해주셨던 매니저님들 모두 고생하셨습니다."}],"\n"]}]
42:null
