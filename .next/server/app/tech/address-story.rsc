...
7:["$","div",null,{"className":"max-w-6xl mx-auto px-4 py-12","children":["$","div",null,{"className":"flex gap-8 justify-center xl:justify-start","children":[["$","article",null,{"className":"flex-1 max-w-3xl","children":[["$","header",null,{"className":"mb-8","children":[["$","div",null,{"className":"flex items-center gap-2 text-sm text-muted-foreground mb-4","children":["$","$L6",null,{"href":"/tech","className":"hover:text-foreground transition-colors capitalize","children":"tech"}]}],["$","h1",null,{"className":"text-4xl font-bold tracking-tight mb-3","children":"주소 이야기"}],["$","div",null,{"className":"flex justify-between items-center gap-3 text-sm text-muted-foreground","children":[["$","time",null,{"dateTime":"2019-06-18T12:00","children":"Jun 18, 2019"}],["$","div",null,{"className":"flex items-center gap-3","children":[["$","$L10",null,{"slug":"address-story"}],["$","span",null,{"children":"15 min read"}]]}]]}]]}],["$","hr",null,{"className":"border-border mb-8"}],["$","$L11",null,{"content":"$12"}],"$L13","$L14","$L15"]}],"$L16"]}]}]
...
13:["$","div",null,{"className":"relative w-full aspect-[3/2] mb-8 rounded-lg overflow-hidden","children":["$","$L17",null,{"src":"https://images.hexdrinker.dev/tech/address-story/thumbnail.png","alt":"주소 이야기","fill":true,"className":"object-cover","priority":true}]}]
...
27:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"이렇듯 최근의 웹의 주소는 URL만으로는 설명하기가 어렵고 URL로 제공되는 웹 사이트도 있지만 진보된 웹 환경에서는 URL이 아니라 URI라고 보는 것이 적합하다."}]
28:["$","h2",null,{"className":"text-2xl font-semibold mt-8 mb-4 pb-2 border-b border-border","id":"urn","children":"URN"}]
29:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"위에서 URL과 URN은 URI의 서브셋이라고 했다. URN에 대해서도 잠깐 언급하도록 하겠다."}]
2a:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["URN은 ",["$","strong",null,{"children":"U"}],"niform ",["$","strong",null,{"children":"R"}],"esourcee ",["$","strong",null,{"children":"N"}],"ame의 약자로 통합 자원 이름이라고 한다."]}]
2b:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["보통 URL의 경우 리소스의 위치가 바뀐다면 기존의 URL로는 해당 리소스에 접근할 수가 없다. 이런 URL의 한계(특정 순간의 리소스의 위치를 나타내는)로 인해 URN 개발이 착수되었다. URN은 리소스의 위치에 영향을 받지 않는 리소스 객체의 ",["$","strong",null,{"children":"고유한 이름"}],"을 말한다. 그렇기 때문에 리소스의 위치가 여기저기 옮겨져도 문제없이 작동한다."]}]
2c:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"현재 웹은 URL 방식을 사용하고 있는데 URN 방식으로의 변경은 매우 크고 어려운 일이다. 표준도 신중하게 정해야하고 수 많은 브라우저 벤더들과의 협의도 필요하다. URL 방식은 뚜렷한 한계를 지니고 있지만 URN 방식으로 완전히 대체할 수 있는 환경이 준비되기 전까지는 계속 쓰일 것이다."}]
2d:["$","h2",null,{"className":"text-2xl font-semibold mt-8 mb-4 pb-2 border-b border-border","id":"ip-주소","children":"IP 주소"}]
2e:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["웹의 주소, 호스트의 주소라고 불리는 것의 실체는 ",["$","strong",null,{"children":"IP(Internet Protocol) 주소"}],"이다. 컴퓨터 간의 네트워크 통신을 위해서는 상대 컴퓨터가 네트워크 상(L3, 네트워크 레이어)에서 어디에 위치하는지(논리적 주소)를 알아야한다. 즉, 네트워크 레이어에서의 컴퓨터의 논리적 위치를 IP 주소라고 하며 IP 주소를 통해 컴퓨터를 식별할 수 있다."]}]
...
30:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"IP 주소는 계층적으로 구성되어 있으며 IPv4 기준 32bit, 총 12개의 수로 이루어져있고 0.0.0.0부터 시작하여 255.255.255.255까지 나타낼 수 있다."}]
31:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["그러나 사람들은 이 복잡한 수를 외우기가 정말 어렵다. (",["$","del",null,{"children":"물론 자주 쓰다보면 외워지겠지"}],") 그래서 IP 주소를 대신하여 사람들이 이해하기 쉬운 주소가 필요했고 이를 위해서 탄생한 것이 ",["$","strong",null,{"children":"도메인 네임"}],"이다. ",["$","strong",null,{"children":"도메인 네임은 URL의 일부"}],"이다. 위의 ",["$","$L6",null,{"href":"#url%EC%9D%98-%EA%B5%AC%EC%84%B1","className":"text-foreground underline underline-offset-4 hover:text-foreground/80","children":"URL의 구성"}],"에서도 볼 수 있듯 길고 긴 URL에서 호스트의 주소만을 도메인 네임이라고 한다."]}]
32:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["근데 컴퓨터는 도메인 네임을 이해할 수 있을까? 결론부터 말하자면, 아니다. 도메인 네임은 네트워크 상에서 호스트의 주소를 인간이 이해하기 쉽게 인간의 언어로 표현한 것이다. 이렇게 호스트의 IP 주소를 도메인 네임으로 바꿔주는 것이 흔히 DNS라고 불리는 ",["$","strong",null,{"children":"도메인 네임 시스템"}],"이다. 물론 그 반대로 도메인 네임을 컴퓨터가 이해할 수 있는 IP 주소로로 바꾸기도 한다."]}]
33:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":["그리고 IP 주소와 함께 언급되는 것 중 ",["$","strong",null,{"children":"MAC 주소"}],"라는 것이 있다."]}]
34:["$","h2",null,{"className":"text-2xl font-semibold mt-8 mb-4 pb-2 border-b border-border","id":"mac-주소-mac-address","children":"MAC 주소 (Mac Address)"}]
35:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"MAC 주소는 랜카드라고 흔히 말하는 네트워크 인터페이스 카드(NIC) 또는 스마트폰의 와이파이 모듈에 할당된 고유 식별값을 말하며 주로 물리적 주소, 하드웨어 주소라고도 한다."}]
36:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":[["$","del",null,{"children":"인터넷에 접속이 가능한 이더넷 기반의 기기에서는 모두 하나 이상씩 갖고 있다."}],["$","br",null,{}],"\n","(요 이야기는 어려울 수 있으니 패스하자)"]}]
37:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"설명 그대로 하드웨어의 주소이기 때문에 생산하고 나서 특별한 문제(해킹)가 생기지 않는 이상 한 번 할당된 값이 변하지 않는다. NIC를 만드는 회사에서 다른 MAC 주소와 겹치지 않는 고유한 주소를 할당하며 그 값은 48bit로 구성되어있다. 그렇다면 IP 주소와 MAC 주소에는 어떤 관계가 있길래 항상 엮이는 것일까?"}]
...
39:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"그렇다면 MAC 주소는 컴퓨터 한 대 당 하나 뿐일까? 그건 아니다. MAC 주소는 NIC에 할당된 값이기 때문에 NIC를 여러 개 붙이면 여러 개 가질 수 있다."}]
3a:["$","h2",null,{"className":"text-2xl font-semibold mt-8 mb-4 pb-2 border-b border-border","id":"끝내며","children":"끝내며"}]
3b:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"웹 세계에서 주소라고 하는 것들에 대해서 이야기를 나눠보았다. 일상에서 손쉽게 접근해서 사용하고 있는 URL에 대해서 좀 더 깊게 알게 되었거나 흥미가 생겼다면 이 포스트는 성공했다고 생각한다."}]
3c:["$","p",null,{"className":"my-4 leading-7 text-foreground/90","children":"IP 주소나 MAC 주소에서는 OSI 7계층과 프로토콜 같은 개념이 묶여있기도 하고 DNS 같은 개념도 언급했기 때문에 이에 대한 것도 다루고 싶지만 글이 길어지기 때문에 추후 다른 포스트에서 다루고자 한다."}]
c:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
3d:I[14638,["/_next/static/chunks/483a12865e0bba97.js","/_next/static/chunks/1d3be43a6dda29b7.js"],"IconMark"]
a:null
e:[["$","title","0",{"children":"주소 이야기 | hexdrinker's devlog"}],["$","meta","1",{"name":"description","content":"웹 세계에서의 주소에 대한 이야기"}],["$","link","2",{"rel":"author","href":"https://github.com/hexdrinker"}],["$","meta","3",{"name":"author","content":"hexdrinker"}],["$","meta","4",{"name":"keywords","content":"network,resource,URL,URI,URN,IP address,MAC address,domain,host"}],["$","meta","5",{"property":"og:title","content":"주소 이야기"}],["$","meta","6",{"property":"og:description","content":"웹 세계에서의 주소에 대한 이야기"}],["$","meta","7",{"property":"og:type","content":"article"}],["$","meta","8",{"property":"article:published_time","content":"2019-06-18T12:00"}],["$","meta","9",{"property":"article:author","content":"hexdrinker"}],["$","meta","10",{"property":"article:tag","content":"network"}],["$","meta","11",{"property":"article:tag","content":"resource"}],["$","meta","12",{"property":"article:tag","content":"URL"}],["$","meta","13",{"property":"article:tag","content":"URI"}],["$","meta","14",{"property":"article:tag","content":"URN"}],["$","meta","15",{"property":"article:tag","content":"IP address"}],["$","meta","16",{"property":"article:tag","content":"MAC address"}],["$","meta","17",{"property":"article:tag","content":"domain"}],["$","meta","18",{"property":"article:tag","content":"host"}],["$","meta","19",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","20",{"name":"twitter:title","content":"주소 이야기"}],["$","meta","21",{"name":"twitter:description","content":"웹 세계에서의 주소에 대한 이야기"}],["$","link","22",{"rel":"icon","href":"/favicon.ico?favicon.d225b73b.ico","sizes":"144x144","type":"image/x-icon"}],["$","link","23",{"rel":"icon","href":"/img/favicon.ico"}],["$","$L3d","24",{}]]
