...
- chat gpt
7:["$","div",null,{"className":"max-w-6xl mx-auto px-4 py-12","children":["$","div",null,{"className":"flex gap-8 justify-center xl:justify-start","children":[["$","article",null,{"className":"flex-1 max-w-3xl","children":[["$","header",null,{"className":"mb-8","children":[["$","div",null,{"className":"flex items-center gap-2 text-sm text-muted-foreground mb-4","children":["$","$L6",null,{"href":"/tech","className":"hover:text-foreground transition-colors capitalize","children":"tech"}]}],["$","h1",null,{"className":"text-4xl font-bold tracking-tight mb-3","children":"Shadow DOM은 대하여"}],["$","div",null,{"className":"flex justify-between items-center gap-3 text-sm text-muted-foreground","children":[["$","time",null,{"dateTime":"2025-05-11T21:00","children":"May 11, 2025"}],["$","div",null,{"className":"flex items-center gap-3","children":[["$","$L10",null,{"slug":"shadow-dom"}],["$","span",null,{"children":"11 min read"}]]}]]}]]}],["$","hr",null,{"className":"border-border mb-8"}],["$","$L11",null,{"content":"$12"}],"$L13","$L14","$L15"]}],"$L16"]}]}]
...
13:["$","div",null,{"className":"relative w-full aspect-[3/2] mb-8 rounded-lg overflow-hidden","children":["$","$L17",null,{"src":"https://images.hexdrinker.dev/tech/shadow-dom/zed.webp","alt":"Shadow DOM은 대하여","fill":true,"className":"object-cover","priority":true}]}]
