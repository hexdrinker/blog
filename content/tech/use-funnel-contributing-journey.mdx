...
<Img
  ...
  alt='rn7-fu15'
  caption='react-navigation 7 버전대와 use-funnel/react-navigation-native 0.0.15 버전'
  width='35%'
/>
...
<Img
  ...
  caption='이미 제목부터가 심상치 않다. navigate 메소드가 더 이상 key option을 허용하지 않는대,,,'
  width='75%'
/>
...
<Img
  ...
  alt='rn6-fu15'
  caption='react-navigation 6 버전대와 use-funnel/react-navigation-native 0.0.15 버전'
  width='35%'
/>
...
<Img
  ...
  alt='rn7-fu16'
  caption='react-navigation 7 버전대와 use-funnel/react-navigation-native 0.0.16(커스텀) 버전'
  width='35%'
/>
...
<Img
  ...
  alt='pr comment'
  caption='한국인 두 명이서 영어로 대화하는 진귀한 광경,,'
/>
